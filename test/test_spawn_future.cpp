...
TEST_CASE("spawn_future will execute its work", "[spawn_future]") {
...
TEST_CASE("spawn_future sender will complete", "[spawn_future]") {
    impulse_scheduler sch;
...
TEST_CASE("spawn_future sender will complete after the given sender completes", "[spawn_future]") {
    impulse_scheduler sch;
    bool executed{false};
    ex::async_scope scope;
...
TEST_CASE("TODO: spawn_future returned sender can be dropped", "[spawn_future]") {
    impulse_scheduler sch;
    // bool executed{false};
    ex::async_scope scope;
...
TEST_CASE("spawn_future returned sender can be captured and dropped", "[spawn_future]") {
    impulse_scheduler sch;
    bool executed{false};
    ex::async_scope scope;
...
TEST_CASE("spawn_future returned sender can be connected but not started", "[spawn_future]") {
    impulse_scheduler sch;
    bool executed{false};
    bool executed2{false};
    ex::async_scope scope;
...
TEST_CASE("spawn_future will start sender before returning", "[spawn_future]") {
    bool executed{false};
    ex::async_scope scope;
...
TEST_CASE(
        "spawn_future will propagate exceptions encountered during op creation", "[spawn_future]") {
    ex::async_scope scope;
    try {
...
TEST_CASE(
        "spawn_future will keep the scope non-empty until the work is executed", "[spawn_future]") {
    impulse_scheduler sch;
    bool executed{false};
    ex::async_scope scope;
...
TEST_CASE("TODO: spawn_future work can be cancelled by cancelling the scope", "[spawn_future]") {
    impulse_scheduler sch;
    ex::async_scope scope;
...
template <typename S>
concept is_spawn_future_worthy = requires(ex::async_scope& scope, S&& snd) {
    scope.spawn_future(std::move(snd));
};

TEST_CASE("spawn_future accepts void senders", "[spawn_future]") {
    static_assert(is_spawn_future_worthy<decltype(ex::just())>);
}
TEST_CASE("spawn_future accepts non-void senders", "[spawn_future]") {
...
TEST_CASE("TODO: spawn_future accepts senders of errors", "[spawn_future]") {
...
TEST_CASE("spawn_future should accept senders that send stopped signal", "[spawn_future]") {
...
TEST_CASE("spawn_future forwards value to returned sender", "[spawn_future]") {
    impulse_scheduler sch;
    ex::async_scope scope;
...
TEST_CASE("TODO: spawn_future forwards error to returned sender", "[spawn_future]") {
    impulse_scheduler sch;
    ex::async_scope scope;
...
TEST_CASE("TODO: spawn_future forwards stopped signal to returned sender", "[spawn_future]") {
    // impulse_scheduler sch;
    ex::async_scope scope;
